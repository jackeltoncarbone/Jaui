...
const Crown     = { Id: 'crown',   Name: 'Carolina Crown' };
const Riverside = { Id: 'reg',     Name: 'Riverside Regiment' };

const Season2026 = { Id: 'season-2026', Name: '2026 Season' };
const Classics   = { Id: 'classics',    Name: 'Classics' };
...
export class Home {
  ...
  readonly Featured = signal<Item[]>([
    {
      Id: 'show-cav', Type: 'Show', Title: 'The Cavaliers: Eclipse',
      CoverUrl: 'https://images.unsplash.com/photo-1643788675571-08073328ffe8?w=800&q=80',
      Description: 'A bold, modern production from one of drum corps most iconic organizations.',
      Company: Cavaliers, Channel: Season2026,
    },
    {
      Id: 'queen-2026', Type: 'Show', Title: 'Queen 2026',
      CoverUrl: 'https://images.unsplash.com/photo-1711336622443-d53a1f1156bc?w=800&q=80',
      Description: 'A tribute to the legendary band Queen.',
      Company: Riverside, Channel: Season2026,
    },
    {
      Id: 'show-blue', Type: 'Show', Title: 'Blue Stars 2025',
      CoverUrl: 'https://images.unsplash.com/photo-1638752097222-ab93e6b15c67?w=800&q=80',
      Description: 'An electrifying performance from the Blue Stars drum corps.',
      Company: BlueStars, Channel: Classics,
    },
  ]);

  readonly Trending = signal<Item[]>([
    {
      Id: 'show-phantom', Type: 'Show', Title: 'Phantom Regiment: Juliet',
      CoverUrl: 'https://images.unsplash.com/photo-1514320291840-2e0a9bf2a9ae?w=800&q=80',
      Description: 'A sweeping romantic narrative told through movement and music.',
      Company: Phantom, Channel: Classics,
    },
    {
      Id: 'show-crown', Type: 'Show', Title: 'Carolina Crown: Inferno',
      CoverUrl: 'https://images.unsplash.com/photo-1557672172-298e090bd0f1?w=800&q=80',
      Description: 'Fire and fury — an explosive visual and musical journey.',
      Company: Crown, Channel: Season2026,
    },
    {
    ...
    {
      Id: 'show-blue-prev', Type: 'Show', Title: 'Blue Stars: Legacy',
      CoverUrl: 'https://images.unsplash.com/photo-1511379938547-c1f69419868d?w=800&q=80',
      Description: 'Celebrating decades of Blue Stars excellence.',
      Company: BlueStars, Channel: Classics,
    },
  ]);
  ...
  readonly Continue = signal<Item[]>([
    {
      Id: 'song-drumline', Type: 'Song', Title: 'Drumline Feature',
      CoverUrl: 'https://images.unsplash.com/photo-1609051589207-264fb1f91000?w=800&q=80',
      Description: 'A showcase of precision and power from the battery.',
      Company: Riverside,
    },
    {
      Id: 'song-brass', Type: 'Song', Title: 'Brass Choir',
      CoverUrl: 'https://images.unsplash.com/photo-1609051461156-8257e7852410?w=800&q=80',
      Description: 'Full brass ensemble opening statement.',
      Company: Riverside,
    },
    {
      Id: 'song-guard', Type: 'Song', Title: 'Color Guard Feature',
      CoverUrl: 'https://images.unsplash.com/photo-1647006885102-22c46e19e256?w=800&q=80',
      Description: 'Silk and steel — a color guard showcase.',
      Company: Riverside,
    },
  ]);
  ...
  readonly Store = signal<Item[]>([
    {
      Id: 'store-crown-pkg', Type: 'Show', Title: 'Crown Premium Package',
      CoverUrl: 'https://images.unsplash.com/photo-1557672172-298e090bd0f1?w=800&q=80',
      Description: 'Full 2026 Carolina Crown show package.',
      Company: Crown,
    },
    {
      Id: 'store-blue-bundle', Type: 'Show', Title: 'Blue Stars Elite Bundle',
      CoverUrl: 'https://images.unsplash.com/photo-1638752097222-ab93e6b15c67?w=800&q=80',
      Description: 'Complete Blue Stars experience.',
      Company: BlueStars,
    },
    {
      Id: 'store-season-pass', Type: 'Show', Title: '2026 Season Pass',
      CoverUrl: 'https://images.unsplash.com/photo-1643788675571-08073328ffe8?w=800&q=80',
      Description: 'Access to every 2026 season show.',
      Company: Riverside,
    },
  ]);
  ...
  readonly Sections = computed<SectionData[]>(() => {
    ...
    if (this.ExtraCard()) {
      featured.push({
        Id: 'bonus', Type: 'Show', Title: 'Toggle me',
        CoverUrl: 'https://images.unsplash.com/photo-1482192505345-5655af888cc4?w=800&q=80',
        Description: 'Bonus card — double-click toggles.',
      });
    }
    return [
