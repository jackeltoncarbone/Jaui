...
// Copied from show-studio/ShowStudio.Web/src/Libraries/Jwift/Jiv/Jiv.ts
...
console.log('[pill-test] drag the sliders to tune; goal: no pure red or cyan, only white');
