        ...
        if (overlayGlass) {
          ...
          if (fromFill !== null) {
            ...
            if (direct !== null) {
              ...
              const gaussian = this._mayGaussian(plan);
              lastBackdrop = this._bcBuild(node, READER_RIM, region, plan.Radius, plan.MaxLod, presample, gaussian, w, h, () => {
                const built = r.ComputeBlur(r.SceneTexture, w, h, plan.Radius, undefined, region, presample, gaussian);
      ...
      if (!phasedPaints) {
        ...
        if (this._sharedBackdrop) {
          ...
          if (groupFill !== null) {
            ...
            const presample = this._mayPresample(plan);
            const gaussian = this._mayGaussian(plan);
            lastBackdrop = this._bcBuild(node, READER_FILL, region, plan.Radius, plan.MaxLod, presample, gaussian, w, h, () => {
