...
- `show-studio/ShowStudio.Web/src/Libraries/Jaui/Jiv/Jiv.ts::GeneratePillPath, GenerateSuperellipsePath` — the original Bezier implementation we derived `1.6236` and `n = 2.55` from
