...
What Jaui code looks like when you use it. These are the target API — implement toward this.

## Vanilla TypeScript

```typescript
import { Canvas, Panel, Text, HStack, Spring } from 'jaui';
...
```typescript
import { ScrollView, Panel, Text } from 'jaui';
...
const outer = new Panel({
  ...
  Children: [
    new Panel({
      // Jaui computes: 4.5 - 1.875 = 2.625em automatically
