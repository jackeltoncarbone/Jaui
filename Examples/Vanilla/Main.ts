...
const el = document.getElementById('jaui') as HTMLCanvasElement;
...
console.log('[Jaui] Click a tab in the nav bar');

(window as unknown as { __jaui: unknown }).__jaui = { canvas, screen, contentColumn, tabBar };
